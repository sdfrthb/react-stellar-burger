...
function BurgerConstructor(props) {
  ...
  const price = fillings.reduce((sum, currPrice) => sum += currPrice.price, bun.price)
  return ( <section className={styles.oder}>
    <BurgerTaste ingredients={props}></BurgerTaste>
    <div className={`${styles.wrapper} mr-4 ml-4`}>
      <span className={`${styles.price_wrapper} text text_type_digits-medium`}>
        {price}
